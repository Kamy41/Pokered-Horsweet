...
; Viridian Gym
	db $FF,45,RHYHORN,42,DUGTRIO,45,NIDOQUEEN,45,NIDOKING,50,RHYDON,0
RocketData:
; Mt. Moon B2F
...
KogaData:
	db $FF,37,KOFFING,39,MUK,37,GOLBAT,43,WEEZING,0
BlaineData:
	db $FF,40,PONYTA,43,MAGMAR,43,RAPIDASH,47,ARCANINE,0
SabrinaData:
